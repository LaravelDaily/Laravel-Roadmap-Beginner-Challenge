    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="container items-center px-5 py-12 lg:px-20">
                <div
                    class="w-full mx-auto text-blueGray-500 border rounded-lg shadow-xl lg:w-1/2 hover:bg-blue-50 hover:scale-125"
                    aria-hidden="false"
                        ...
                        <div class="grid grid-cols-2 justify-items-center">
                            ...
                            <div class="flex mt-4">
                                <form method="POST" action="{{route('article.destroy',$article->id)}}">
                                    ...
                                    @method('DELETE')
                                    <button
                                       class="w-auto px-4 py-2 my-2 text-base font-medium text-white transition duration-500 ease-in-out transform bg-red-600 border-red-600 rounded-md focus:shadow-outline focus:outline-none focus:ring-2 ring-offset-current ring-offset-2 hover:bg-red-800"
