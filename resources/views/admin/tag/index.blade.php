        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <!-- New tag Modal toggle start -->
                    <div class="pb-4 bg-white dark:bg-gray-900">
                        <a href="#" type="button" data-modal-target="new-tag-modal"
                           data-modal-toggle="new-tag-modal"
                    ...
                    <!-- New tag Modal toggle end -->

                    <!-- New tag Main modal start -->
                    <div id="new-tag-modal" tabindex="-1" aria-hidden="true" data-modal-backdrop="static"
                        ...
                        <div class="relative p-4 w-full max-w-md max-h-full">
                            ...
                            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                ...
                                <!-- Modal body -->
                                <form action="{{route('admin.tag.store')}}" class="p-4 md:p-5" method="POST">
                                    @csrf
                                    <div class="grid gap-4 mb-4 grid-cols-2">
                                        <div class="col-span-2">
                                            ...
                                            <input type="text" name="name" id="name"
                                                   ...
                                                   placeholder="Type the tag name" required="">
                                        </div>
                                    </div>
                    ...
                    <!-- New tag Main Modal end -->

                    <!-- tag Table List start -->
                            ...
                            @foreach($getTagList as $key => $tag)
                                <tr class="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700">
                                    ...
                                    <td class="px-6 py-4 text-center">
                                        ...
                                        <!-- Edit tag Modal toggle start -->
                                        <button type="button" data-modal-target="edit-tag-modal-{{$key}}"
                                                data-modal-toggle="edit-tag-modal-{{$key}}"
                                        ...
                                        <!-- Edit tag Modal toggle end -->

                                        <!-- Edit tag Main modal start -->
                                        <div id="edit-tag-modal-{{$key}}" tabindex="-1" aria-hidden="true"
                                        ...
                                        <!-- Edit tag Main modal end -->

                                        <!-- Remove tag Modal toggle start -->
                                        ...
                                        <!-- Remove tag Modal toggle end -->

                                        <!-- Remove tag Main Modal start -->
