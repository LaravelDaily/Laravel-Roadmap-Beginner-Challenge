                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                        <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                            ...
                            <tbody>
                            @foreach($getArticleList as $key => $article)
                                <tr class="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700">
                                    ...
                                    <td class="px-6 py-4 text-center">
                                        ...
                                        <!-- Edit article Modal toggle start -->
                                        ...
                                        <!-- Edit article Modal toggle end -->

                                        <!-- Remove article Modal toggle start -->
                                        ...
                                        <!-- Remove article Modal toggle end -->

                                        <!-- Remove article Main Modal start -->
                    ...
                    <div class="flex flex-col mt-5">
                        {{$getArticleList->links()}}
                    </div>
                    <!-- article Table List end -->
                </div>
            </div>
        </div>
    </div>
