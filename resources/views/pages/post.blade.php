    ...
    <div class="py-12 min-h-screen">
        <div class="container mx-auto px-4 flex flex-wrap lg:flex-nowrap">
            ...
            <div class="xl:w-6/12 lg:w-8/12 w-full lg:mx-6">
                        ...
                        <div class="flex flex-wrap gap-2 mt-4">
                            @foreach ($post->tags as $tag)
                                <a href="{{ route('showByTagName', ['tagName' => $tag->name]) }}"
                                    class="px-3 py-1 text-sm border border-gray-200 rounded-sm hover:bg-blue-500 hover:text-white transition">{{ $tag->name }}</a>
                            @endforeach
                        </div>
                ...
                <div class=" bg-white px-3 py-2 text-center rounded-sm mb-5 mt-8">
                        ...
                        <div class="bg-white p-3 shadow-sm rounded-sm mb-4">
                            <a href="#" class="overflow-hidden block">
                                <img src={{ asset('storage/uploads/' . $relatedPost->image) }}
                                    class="w-full h-40 object-cover rounded transform hover:scale-110 transition duration-500"
                                    alt="">
                            </a>
                            <div class="mt-3">
                                <a href="{{ route('post', $relatedPost->id) }}">
                                    <h2
                                        class="text-base font-semibold text-gray-700 font-roboto hover:text-blue-500 transition">
                                        {{ $relatedPost->title }}
                                    </h2>
                                </a>
                                <div class="flex mt-2">
