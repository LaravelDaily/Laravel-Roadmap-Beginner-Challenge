...
@section('content')
    <div class=" w-100 d-flex flex-column align-items-center mt-4">
        <div>
            <h3>Hello, Im' Denis Feliciano</h3>
            <p>I'm currently in São Paulo city in Brazil, and i'm fullstack developer
            ...
            <p>To learn more about the challenge visit the link above</p>
        </div>
    </div>
@endsection
