...
<body>
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-warning shadow-sm bg-warning fixed-top">
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ms-auto">
                        ...
                        @guest
                            @if (Route::has('login'))
                                <li class="nav-item">
                                    <a class="nav-link active" href="{{ route('login') }}">{{ __('Login Admin') }}</a>
                                </li>
                            @endif
        ...
        <main class="p-2 container bg-white" style="margin-top: 4rem;">
            @yield('content')
        </main>
    </div>
</body>
